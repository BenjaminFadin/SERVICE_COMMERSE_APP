...
urlpatterns = [
    ...
    # STATUS CHANGING FOR PROVIDER
    path("appointment/<int:appointment_id>/status/", views.appointment_change_status, name="appointment_change_status"),
    ...
    path("docs/<str:doc_type>/", views.serve_doc, name="serve_doc"),
]